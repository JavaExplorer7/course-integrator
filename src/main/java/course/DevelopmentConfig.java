	...
	public CommandLineRunner dataLoader(CourseRepository repo,
		...
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				repo.save(new Course("PESS12010", "PE Health Knowledge", Type.PFC, 1.0, 32, 0, 1));
				repo.save(new Course("PESS12020", "PE (Swimming)", Type.PFC, 1.0, 32, 0, 2));
				repo.save(new Course("PESS22030", "PE Optional Skills I", Type.PFC, 1.0, 32, 0, 3));
				repo.save(new Course("PESS22040", "PE (Running)", Type.PFC, 1.0, 32, 0, 4));
				...
				repo.save(new Course("MATH10012", "Higher Mathematics I", Type.PFC, 5.0, 80, 0, 1));
				repo.save(new Course("MATH10022", "Higher Mathematics II", Type.PFC, 6.0, 96, 0, 2));
				repo.save(new Course("MATH10032", "Linear Algebra II", Type.PFC, 3.0, 48, 0, 1));
				repo.save(new Course("MATH20041", "Probability & Statistics I", Type.PFC, 3.0, 48, 0, 3));
				repo.save(new Course("MATH31922", "Database Principle", Type.PO, 3.0, 32, 16, 0));
				repo.save(new Course("PHYS10013", "College Physics", Type.PFC, 3.5, 56, 0, 2));
				repo.save(new Course("PHYS12010", "College Physics Experiment", Type.PFC, 1.5, 0, 48, 2));
